export default function Loading() {
  return (
    <div className="min-h-screen" role="status" aria-live="polite" aria-busy="true">
      <span className="sr-only">Loading VeilSub content, please wait</span>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="animate-pulse mb-8">
          <div className="h-8 w-52 rounded-lg bg-white/[0.06] mb-4" />
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="p-8 rounded-2xl bg-white/[0.02] border border-border animate-pulse"
            >
              <div className="h-5 w-24 rounded-lg bg-white/[0.06] mb-4" />
              <div className="h-8 w-20 rounded-lg bg-white/[0.06] mb-4" />
