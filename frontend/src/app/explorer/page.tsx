                  ...
                  {paginatedEvents.map((event, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 min-w-0">
                          ...
                          {event.tx_id && (
                            <>
                              ...
                              <a
                                href={event.tx_id?.startsWith('at1') ? `https://testnet.explorer.provable.com/transaction/${event.tx_id}` : `https://testnet.explorer.provable.com/program/veilsub_v16.aleo`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="shrink-0 p-1 rounded hover:bg-white/10 text-slate-500 hover:text-white transition-colors"
                        ...
                        <a
                          href={event.tx_id ? (event.tx_id.startsWith('at1') ? `https://testnet.explorer.provable.com/transaction/${event.tx_id}` : `https://testnet.explorer.provable.com/program/veilsub_v16.aleo`) : '#'}
                          target="_blank"
                          rel="noopener noreferrer"
