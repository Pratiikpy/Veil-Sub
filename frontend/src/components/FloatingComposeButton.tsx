  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 md:bottom-8 right-6 md:right-[270px] z-50 w-14 h-14 rounded-full bg-[var(--foreground)] text-[var(--bg-base)] flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-transform focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none"
