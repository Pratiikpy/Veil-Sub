        ...
        return (
          <div key={item.id}>
            <button
              ...
              className="flex w-full items-center justify-between gap-3 py-4 text-left text-sm font-medium text-white/90 hover:text-white transition-colors duration-150"
            >
