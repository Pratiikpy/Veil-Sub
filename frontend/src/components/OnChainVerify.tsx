...
export default function OnChainVerify({
  ...
  if (state === 'idle') {
    return (
      <button
        ...
        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium bg-white/[0.05] border border-[rgba(255,255,255,0.06)] text-[#a1a1aa] hover:text-white hover:bg-white/[0.08] transition-all"
      >
  ...
  if (state === 'verifying') {
    return (
      <span role="status" className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium bg-violet-500/10 border border-violet-500/20 text-[#a1a1aa]">
