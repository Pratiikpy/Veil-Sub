...
export default function ShareText({ text }: { text: string }) {
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={copy}
        className="mt-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-sm text-muted hover:bg-white/10 transition-all duration-300 flex items-center gap-2 active:scale-[0.98]"
      >
