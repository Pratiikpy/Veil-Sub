    ...
    <section className="py-24 lg:py-36 section-divider">
      <Container>
        ...
        <div className="relative mt-14">
          ...
          <StaggerContainer className="flex gap-4 overflow-x-auto snap-x snap-mandatory no-scrollbar scrollbar-stable pb-4 -mx-4 px-4 sm:mx-0 sm:px-0 sm:pb-0 sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:overflow-visible">
            {CONTRACT_FEATURES.map((feature) => {
              ...
              return (
                <m.div key={feature.title} variants={staggerItemVariants} className="min-w-[260px] shrink-0 snap-start sm:min-w-0 sm:shrink">
                  <SpotlightCard className="group relative p-6 sm:p-8 rounded-3xl glass glass-accent transition-all duration-300 h-full">
