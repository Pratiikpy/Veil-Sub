...
const ORB_TOP_RIGHT_STYLE = {
  background: 'radial-gradient(circle, rgba(255, 255, 255, 0.03) 0%, rgba(255, 255, 255, 0.008) 50%, transparent 70%)',
} as const

const ORB_TOP_LEFT_STYLE = {
...
function BackgroundOrbs() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      {/* White orb -- top right (responsive: 350px on mobile, 700px on sm+) */}
      <div
      ...
      <div
        ...
        style={ORB_TOP_LEFT_STYLE}
      />
      {/* Subtle white glow -- center (responsive) */}
      <div
