    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          marginLeft: -300,
          marginTop: -300,
          background: 'radial-gradient(circle 300px, rgba(139,92,246,0.04), transparent)',
          zIndex: 9998,
      ...
      <div
        ...
        style={{
          ...
          borderRadius: '50%',
          background: hovering ? 'transparent' : 'rgba(139,92,246,0.8)',
          border: hovering ? '1.5px solid rgba(139,92,246,0.5)' : 'none',
