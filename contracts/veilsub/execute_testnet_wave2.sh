...
echo "Execute them via the FRONTEND (veil-sub.vercel.app) or via leo execute with record literals."
echo ""
echo "--- SUBSCRIBE (core flow) ---"
echo "1. subscribe: Connect a SECOND wallet to veil-sub.vercel.app, navigate to creator page, click Subscribe"
