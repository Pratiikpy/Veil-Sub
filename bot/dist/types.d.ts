export type EventType = 'subscriber_change' | 'revenue_change' | 'dispute_filed' | 'expiry_warning' | 'platform_stats' | 'content_published' | 'creator_registered' | 'bot_started' | 'bot_stopped' | 'poll_error';
