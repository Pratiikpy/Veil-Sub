...
| `transfer_subscription` | 300,000 | 0.30 | Yes | 1 (new AccessPass) | Consumes old pass + new pass |
| `revoke_access` | 150,000 | 0.15 | Yes | 0 | Single mapping write |
| `enforce_revocation` | 150,000 | 0.15 | Yes | 0 | Mapping check + assert |
...
| Finalize-only (no records) | 150,000-200,000 | 10 | Moderate — mapping writes only |
| Record-creating (1-2 records) | 200,000-350,000 | 11 | Standard — ZK proof + records |
